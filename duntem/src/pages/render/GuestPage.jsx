...
export const GuestPage = () => {
    const { isLoginedUserToStorage, getLoginedUserProvider, getLoginedUserID } =
        authUtil();
    const { getFirebaseUserData } = authService();
        ...
        if (isLoginedUserToStorage()) {
            try {
                if (getLoginedUserProvider() === "google") {
                    getFirebaseUserData(getLoginedUserID()).then((res) => {
                        res.forEach((doc) => {
